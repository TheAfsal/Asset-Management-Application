            ...
            <Grid item xs={12} md={4}>
              ...
              >
                ...
                <Typography variant="body2" className="text-gray-300 mb-4">
                  Luxury Asset Management System designed for modern businesses.
                  Streamline your operations with elegance and efficiency.
                </Typography>
          ...
          }
          {
            ...
            <Grid item xs={12} md={2}>
              ...
              >
                <Typography
                  variant="h6"
                  className="font-semibold mb-4 text-indigo-400"
                >
                  Features
                </Typography>
